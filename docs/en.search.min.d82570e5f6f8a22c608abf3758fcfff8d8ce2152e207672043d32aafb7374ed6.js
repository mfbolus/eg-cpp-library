...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/eg-cpp-library/flexsearch.min.js');loadScript('/eg-cpp-library/en.search-data.min.0db16fbc7ceaffaf38e8e6bcbaea78f7a47ac9cef4a0de0143413476417bc363.js',function(){input.required=false;search();});}
