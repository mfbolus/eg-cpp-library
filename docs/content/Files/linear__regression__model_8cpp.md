---
title: src/linear_regression_model.cpp
summary: defines an example class type 

---

# src/linear_regression_model.cpp

defines an example class type  [More...](#detailed-description)
...
```cpp
//===-- linear_regression_model.cpp - Model Class -------------------------===//
//
...
LinearRegressionModel::LinearRegressionModel(const arma::mat& x,
                                             const arma::mat& z)
    : n_x(x.n_rows),
      n_y(z.n_rows),
...
LinearRegressionModel::LinearRegressionModel(const arma::mat& C,
                                             const arma::vec& d,
                                             const arma::mat& R)
    : n_x(C.n_cols),
      n_y(C.n_rows),
...
auto LinearRegressionModel::simulate(const arma::mat& x, bool add_noise)
    -> arma::mat {
  size_t n_t(x.n_cols);  // number of time samples
